...
import { ProcurementPlanningDetails } from '@/components/SiteDetailsView';
          ...
          <CardContent className="p-3 sm:p-4 space-y-3">
            ...
            {selectedSite?.id === site.id && (
              <div className="space-y-3 border-t pt-3">
                <ProcurementPlanningDetails site={site} />
            ...
            <div className="space-y-4">
              {viewSubmission.sites && (
                <div>
                  ...
                  <ProcurementPlanningDetails site={viewSubmission.sites} />
                </div>
              )}
              <div>
